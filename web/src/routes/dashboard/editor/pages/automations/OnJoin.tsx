...
const OnJoin: React.FC = () => {
  ...
  return (
    <FlexColumn style={{ gap: 25 }}>
      ...
      <FlexColumn>
        <FlexRow style={{ borderRadius: 5, cursor: "pointer" }} className={`${styling.align_self_stretch} ${styling.justify_content_center} ${styling.align_items_center} ${styling.main}`}>
