...
class compliment(commands.Cog):
    ...
    async def compliment(self, interaction: discord.Interaction, user: discord.User):
        ...
        _input = f"User {interaction.user.display_name or interaction.user.name} is asking you to compliment"

        if interaction.user.id in [342797306980204561] and user.id in [342797306980204561]:
            _input = "Your creator is asking you to compliment himself..."

        elif interaction.user.id in [342797306980204561] and user.id in [1371990578912559136, 932999965498834954]:
            _input = "Your creator is asking you to compliment yourself..."
        ...
        _instructions = """
                ...
                People will sometimes ask you to compliment other people within the server.
                You will be given the user who requests a compliment and the target.
